...
This uses matplot lib to generate a histogram to make the diagram. It will be outputted as a png. It takes the file generated by running the compiled gen\_data.cpp as an argument
